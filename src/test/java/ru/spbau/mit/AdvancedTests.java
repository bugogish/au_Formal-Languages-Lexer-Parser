...
public class AdvancedTests {
    ...
    public void testFileInput() throws IOException, LexException {
        ...
        Lexer lexer = new LLanguage(new ANTLRFileStream(file.getAbsolutePath()));
